...
export default function LoginForm() {
  ...
  return (
    <div className={`${darkMode && "dark"}`}>
      ...
      <div className="min-h-screen xl:flex-row xl:h-screen  bg-black flex-col overflow-x-hidden dark:bg-neutral-100 flex justify-center items-center ">
        <div className="text-white px-6 xl:px-0 flex flex-col max-sm:items-center justify-center">
          <h1 className="font-bold text-5xl xl:w-[500px] mt-4 xl:mt-0 relative max-sm:left-[50px] max-sm:text-3xl max-sm:w-[380px] dark:text-black ">
            Comece agora com{" "}
            <span className="bg-gradient-to-r from-cyan-500 to-blue-800 inline-block text-transparent bg-clip-text">
              HD support
            </span>
          </h1>
          <p className="xl:w-[500px] px-4 xl:px-0 relative max-sm:w-[380px] mt-4 dark:text-black">
        ...
        <div className="w-full xl:w-[500px] px-6 xl:px-0 flex flex-col relative max-sm:top-[10px] justify-center items-center">
          ...
          >
            <div className="w-full flex items-center max-sm:w-[380px] justify-center dark:bg-slate-300 dark:text-black text-neutral-300  xl:w-[500px] rounded h-[60px] mt-5 bg-neutral-950 text-lg border-none">
              <Input
                value={nome}
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="lucide lucide-user  relative right-5"
              >
            ...
            <div className="w-full flex items-center max-sm:w-[380px] justify-center text-neutral-300 dark:bg-slate-300 dark:text-black xl:w-[500px] rounded h-[60px] mt-5 bg-neutral-950 text-lg border-none">
              <Input
                type="email"
                value={email}
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="lucide lucide-at-sign relative right-5 "
              >
            ...
            <Button
              type="submit"
              className="w-full ark:bg-gradient-to-r  max-sm:w-[380px] dark:from-black dark:to-black bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded text-lg xl:w-[500px] h-[50px] mt-10 transition-all ease-in-out duration-1000 hover:from-blue-500 hover:via-sky-400 hover:to-cyan-500 "
            >
              Criar conta
            </Button>
            ...
            <div className="text-white relative max-sm:bottom-[20px] text-center mt-3">
              <span className="text-blue-200 font-bold">
                ...
                <Link
                  href="/login"
                  className="text-sky-400 font-bold dark:text-black"
                >
                  Entre agora
                </Link>
              </span>
