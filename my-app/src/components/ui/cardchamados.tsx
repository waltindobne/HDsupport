  ...
  []);
    return(
        <div className="flex flex-col w-full">
             <div className="w-[370px] max-[1400px]:w-[300px] p-[10px] rounded-[10px] dark:border-black border-2 border-slate-50 space-y-3 h-[100px] bg-black dark:bg-white max-[1000px]:w-[200px] max-[600px]:w-full">
