...
export default function Header(){
    ...
    return(
        <div className={`${darkMode && "dark"}`} >
            ...
            <header className="w-[90%] border-2 max-sm:justify-between max-sm:w-[90%]  h-[100px] items-center rounded-[20px] mt-5 justify-around  p-[35px] flex dark:border-neutral-950 bg-neutral-950 dark:bg-slate-50">
            <div className="text-neutral-950  justify-start flex items-start relative max-sm:left-0 left-10">
              <Button
                className="bg-neutral-950 dark:bg-slate-50  text-slate-50 dark:text-neutral-950  border-none outline-none shadow-none"
                onClick={handleNavigation}
              >
                <h1 className="text-[30px] font-black bg-trasparent w-[125px] ">
                  Help desk
                </h1>
              </Button>
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-rocket-takeoff text-slate-50 dark:text-neutral-950 relative bottom-1"
                viewBox="0 0 16 16"
              >
