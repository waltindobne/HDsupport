  ...
  const [darkMode, setDarkMode] = useState(false); 
    ...
    return(
      <div className={`${darkMode && "dark"}`} >
        <Header />
          <div className="flex justify-around items-center max-w-[90%] mb-10 flex-wrap w-[100%] border-2 max-sm:h-[300px] border-slate-50  rounded-[20px] bg-neutral-950 dark:border-neutral-950 dark:bg-slate-50 h-[80vh] m-auto mt-5">
          <div className="flex justify-around items-center flex-wrap max-w-[95%]">
            <div className="flex items-center justify-around flex-col max-w-[50%]">
              <h1 className="text-slate-50 max-sm:text-[30px] max-sm:w-[350px] max-sm:text-center dark:text-neutral-950 text-[48px] w-[100%] font-black">
              ...
              <h1 className="text-[15px] max-sm:w-[300px] max-sm:left-[3px] max-sm:text-[10px] rounded-br-[20px] border-slate-50 border-2 rounded-l-[20px] solid p-[20px] relative right-[50px] bg-blue-700 dark:border-neutral-950 text-slate-200  w-[83%]">
